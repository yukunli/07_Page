...
在很多生产领域中，物质的水分含量是生产过程中的重要参数。因而准确、快速地测量出物质中的水分含量具有重要的意义。在水分检测方法中，近红外检测法具有非接触、可连续、测量速度快等特点，在很多领域得到了广泛的应用。传统的近红外水分仪存在可动部件，机械的转动会影响仪器的测量精度和稳定性，仪器的功耗和体积也比较大。
