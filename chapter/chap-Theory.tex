...
式~\ref{q5}~为理想状态下的比值，式~\ref{q6}~为实际测量中受物料表面的质地影响的比值，可以看出两种状态下的结果是一样的，可见，若恰当选择测量波长和两个参比波长，可以在一定程度上大大减小质地带来的影响，提高测量精度\upcite{c2theoc1}。正如~\ref{chap2.1}~小结中所述，本课题选取的测量波长为~1.94$\mu m$，参考波长分别为~1.75$\mu m$~和~2.20$\mu m$。
