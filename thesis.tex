...
%改变行间距
%\setlength{\baselineskip}{1.5\baselineskip}  % 或者\
\linespread{1.5}
...
\usepackage{multirow}
\usepackage{tabularx}
\setlength{\abovecaptionskip}{0.5pt}  %使图的英文图题距离中文图题变近，但是对于表格，英文表题与表距离变大了，

%\usepackage{ccmap}   %使 pdf中可复制文本
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \reviewer{王玉涛~~教授~~~~吴新杰~~教授 }
  \institute{信息科学与工程学院}
  \school{东~~~北~~~大~~~学}
  \chairman{谢植~教授}

  % 英文封面内容
  \englishdescription{A Thesis in Measuring Technology and Automatic Instruments}
