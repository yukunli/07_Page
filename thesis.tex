...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % 英文封面内容
  \englishdescription{A Thesis in Theoretical Physics}
  \englishtitle{Constraining dark energy with Hubble parameter measurements}
  \englishauthor{Yu-Kun Li}
  \englishadvisor{Professor  Xingguang Li}
